...
class _InputPage extends State<InputPage> {
  ...
  String _nombre = '';
  String _email = ''; //Debo de iniciar mi variable vacía para que no hbay problema con el tipo late
  String _fecha = '';
  ...
  TextEditingController _inputFiedDateController = new TextEditingController();
 ...
 Widget _crearFecha(BuildContext context) {
  return TextField(
      ...
      controller: _inputFiedDateController,
      decoration: InputDecoration(
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(20.0)
        ),
  ...
  DateTime? picked = await showDatePicker(
    ...
    if (picked != null){
      setState(() {
        ...
        _inputFiedDateController.text = _fecha;
      });
    }
